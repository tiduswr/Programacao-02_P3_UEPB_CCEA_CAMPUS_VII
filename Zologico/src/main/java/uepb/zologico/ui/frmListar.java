...
public class frmListar extends JDialog {
    ...
    public frmListar(Object[][] src, String[] headers, String tipo, String title) {
        initComponents();
        this.source = src;
    ...
    public frmListar(Object[][] src, String[] headers, String tipo, String title, int returnValueFromCol) {
        initComponents();
        this.source = src;
        this.headers = headers;
        this.tipo = tipo;
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Listagem de Dados");
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
        ...
        if(selected != -1){
            try{
                ...
                JOptionPane.showMessageDialog(null, "Argumento de retorno da Coluna esta fora do Range da tabela!");
            }
        }else{
